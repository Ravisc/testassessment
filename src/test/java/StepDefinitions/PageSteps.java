...
public class PageSteps {
	...
	public void user_clicks_on_main_hamburger_menu() throws InterruptedException {
	
		Helper.click(driver, hamburgerMenu.hamburgerMenu);
	}

	@Then("user clicks on the 'TV, Appliances and Electronics' menu item")
	public void user_clicks_on_the_tv_appliances_and_electronics_link() throws InterruptedException {
	...
	public void user_clicks_on_televisions_under_tv_audio_cameras_link() throws InterruptedException {
	...
	public void user_should_see_about_section(String expectedText) {
		...
		Assert.assertEquals(expectedText, productPage.AboutThisItemTitle.getText());
         System.out.println(productPage.AboutThisItemTitle.getText());
